const header = '<div class="Layout-sc-nxg1ff-0 hbYWXo side-nav-header" data-a-target="side-nav-header-expanded"><h2 class="header-text">Cool Channels</h2></div>';
...
function buildCategory(channelList){
  const folders = categories.reduce((acc,curr) => ({[curr] : columnTemplate.content.cloneNode(true), ...acc}),{})
